		...
		<div class="row">
			...
			<div class="col-md-12">
				...
				<div class="box_style_2" id="main_menu">
					...
					<h2 class="inner">Your Account Has Been Created!</h2>

                    <h4 style="color:green;">Thank you for registering with MySpiceOfLife!<br/>



                    You will be notified by email once your account has been activated by the store owner.<br/>

                    

                    If you have ANY questions about the operation of this online shop, please contact the store own</h4>
