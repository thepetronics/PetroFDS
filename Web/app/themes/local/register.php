...
<div class="container margin_60_35">
	...
	<div id="container_pin">
		...
		<div class="row">
            ...
            <form action="setups/files/register_edit.php" method="post" enctype="multipart/form-data" id="form" name="form" onSubmit="return validateForm();">

            <div class="col-md-12">

                <div class="page-content">

                    <h2 class="page-content-title"><i class="icon-group"></i>NEW USER REGISTRATION</h2>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <p>
                                    ...
                                    <input type="email" autocomplete="off" class="required-item" id="email" name="email" value="" onkeyup="Checkemail(this.value)" aria-required="true" placeholder="Email">			
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="hidden" value="register" name="method" id="method" />
