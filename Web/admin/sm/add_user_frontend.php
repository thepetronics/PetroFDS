...
<script language="javascript" type="text/javascript" src="../js/user_profile.js"></script>
  <title>PetroFDS | Add Frontend User</title>
</head>
...
<script type="text/javascript">
  ...
  function validate()
  {
    ...
    obj.open("GET",site_root+"validate_frontend.php?email="+email,true);
    obj.send(null);
  }
</script>
...
<tr>
	<td>
<label>&nbsp;</label>
<center><label style="font-family:Arial,Helvetica,sans-serif;font-size:25px;color:#f16445;text-align:center" >ADD FRONTEND USER</label></center>
...
<div id="page"   style="left:0px; right: 0px; margin-left:90px; padding:0px;" >
	<div class="limiter clear-block">
    	...
    	<div class="page-content content-wrapper clear-block" style="width:600px;"  >
        	...
        	<form  onsubmit='return false;' autocomplete="off" action="save_add_user_frontend.php" accept-charset="UTF-8" method="post" id="add_user_form" name="add_user_form" enctype="multipart/form-data">
                    ...
                    <table >
                    	<tr>
                        	<td width="216">
                                ...
                                <input maxlength="64" style="width:200px" name="email" id="email"  class="form-text required fluid" type="email">
								<div id="msg"></div>
                            </td>
                            <td width="164">
                    ...
                    <table >
                        ...
                        <tr>
                        	<td>
                                ...
                                <input  style="width:250px" name="contact_no" id="contact_no" value=""  class="form-text required fluid" type="number">
                            </td>
                            <td>
                            	<label for="edit-mail">Post Code: <span class="form-required" title="This field is required.">*</span> </label>
                                <input  style="width:250px" name="post_code" id="post_code" value=""  class="form-text required fluid" type="text">
                            </td>
                        </tr>
                        <tr>
                        	<td>
                            	<label for="edit-mail">Address 1: <span class="form-required" title="This field is required.">*</span> </label>
                                <input  style="width:250px" name="add_1" id="add_1" value=""  class="form-text required fluid" type="text">
                            </td>
                            <td>
                            	<label for="edit-mail">Address 2: </label>
                                <input  style="width:250px" name="add_2" id="add_2" value=""  class="form-text required fluid" type="text">
                            </td>  
                        </tr>
                        <tr>
                        	<td>
           						<label for="edit-mail">City: <span class="form-required" title="This field is required.">*</span> </label>
                                <input  style="width:250px" name="city" id="city" value=""  class="form-text required fluid" type="text">
                            </td>
                            <td>
