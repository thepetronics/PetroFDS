<?php 
	...
	$stmt = $conn->prepare("SELECT * FROM option_type");
...
<head>
  ...
  <title>PetroFDS | Set Option Type</title>
</head>
...
<br />
<br /> 
<a href="set_option_type?status=new" style="float:right; text-decoration:none;"><input type="button" class="form-submit" value="Add New Option Type" /></a>
<br />
<br />
<div id="content-area">
...
?>
		<tr>
            	<td><a href="set_option_type?status=edit&id=<?php echo $row['id'] ?>" style="text-decoration:none;">
 					<?php echo $row['id'] ?>	               
                </a></td>
				<td><a href="set_option_type?status=edit&id=<?php echo $row['id'] ?>" style="text-decoration:none;">
 					<?php echo $row['type'] ?>               
